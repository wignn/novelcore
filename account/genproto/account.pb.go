...
func (x *Account) GetCreatedAt() []byte {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *EditAccountRequest) GetAvatarUrl() string {
	if x != nil {
		return x.AvatarUrl
	}
	return ""
...
func (x *EditAccountRequest) GetBio() string {
	if x != nil {
		return x.Bio
	}
	return ""
...
const file_account_proto_rawDesc = "" +
	"\n" +
	"\raccount.proto\x12\bgenproto\"\xa7\x01\n" +
	"\aAccount\x12\x0e\n" +
	...
	"\n" +
	"created_at\x18\a \x01(\fR\tcreatedAt\"Z\n" +
	...
	"\tdeletedID\x18\x03 \x01(\tR\tdeletedID\"\x9b\x01\n" +
